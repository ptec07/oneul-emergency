...
describe('오늘응급 검색 흐름', () => {
  ...
  it('uses browser geolocation coordinates for current-location emergency search', async () => {
    ...
    await waitFor(() => expect(mockFetchEmergencyRooms).toHaveBeenCalledWith({ lat: 37.501, lng: 127.039, radiusM: 5000 }))
  })
  ...
  it('geocodes an address query and searches emergency rooms around the matched coordinates', async () => {
    ...
    await waitFor(() => expect(mockFetchEmergencyRooms).toHaveBeenCalledWith({ lat: 37.4979, lng: 127.0276, radiusM: 5000 }))
  })
